...
const messages = {
	en: {
		...
		years : "years old",
		profile: "Informatic student, and programmer. Without fear a news challenges, and keep on constant learning. I love tech and nature.",
		pitagorasSentence : "With order and time, it's foun the secret to do it all, and do it well.",
		myJob : "Software developer in Tek-Know Solutions.",
		...
		_experience3 : "Ademia (Software factory) / November 2017 - April 2018. Guadalajara, Mexico.",
		...
		_experience4 : "Tek-Know Solutions (IT Consuilting)/ June 2018 - Actual. Caracas, Venezuela.",
		experience_description4 : "SPA, PWA web applications, and hybrids mobile apps with Angular JS and IONIC framework.",
		number : "Phone number",
	...
	es: {
		...
		years : "años",
		profile: "Estudiante de informatica, y programador. No me asustan los retos, y me mantengo en constante capacitacion. Amo la tecnologia y la naturaleza.",
		pitagorasSentence : "Con orden y tiempo se encuentra el secreto de hacerlo todo, y de hacerlo bien.",
		myJob : "Desarrollador de software en Tek-Know Soluciones.",
		...
		projects : "Proyectos",
		posts : "Publicaciones",
		experience : "Experiencia profesional (5 anos)",
		...
		_experience3 : "Ademia (Fabrica de Software) / November 2017 - Abril 2018. Guadalajara, Mexico.",
